...
// Import only the Modal component to avoid bundling the entire Bootstrap
// library, which would register duplicate event handlers (e.g. Dropdown
// clearMenus) and break other Bootstrap components like dropdowns.
